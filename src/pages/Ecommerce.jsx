      ...
      <div className="flex gap-10 flex-wrap justify-center">
        ...
        m-3 rounded-2xl md:w-780">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-1 border-color m-4 p-4 pr-20">
              <div className="">
                <p>
                  <span className='text-3xl font-semibold'>₹93,989</span>
              ...
              <div className="mt-6">
                <p>
                  <span className='text-3xl font-semibold'>₹59,989</span>
                  {/* <span className='p-1.5 hover:drop-shadow-xl cursor-pointer
                rounded-full text-white bg-green-400 ml-3 text-xs'>23%</span> */}
                </p>
